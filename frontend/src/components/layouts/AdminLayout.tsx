            ...
            ${sidebarOpen ? 'opacity-100 w-auto' : 'opacity-0 w-0'}`}>
              ...
              ${sidebarOpen ? 'opacity-100 w-auto' : 'opacity-0 w-0'}`}
                                                            ...
                                                            <button
                                                                        ...
                                                                        className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-gray-300 hover:bg-red-500/20 hover:text-red-400 transition-all group"
                                                            >
                                                                        <LogOut size={20} className="min-w-[20px] transition-transform group-hover:scale-110" />
                                                                        <span
                                                                                    className={`font-medium transition-all duration-200 overflow-hidden whitespace-nowrap
              ${sidebarOpen ? 'opacity-100 w-auto' : 'opacity-0 w-0'}`}
                                                                        >
                                                                        ...
                                                                        <div className="flex items-center gap-4">
                                                                                    ...
                                                                                    <div className="relative hidden md:block">
                                                                                                ...
                                                                                                <input
                                                                                                            type="text"
                                                                                                            placeholder="Search..."
                                                                                                            className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-64 transition-all"
                                                                                                />
                                                                                    </div>
